        ...
        sections: [
            FAQ.Section(
                ...
                questions: [
                    ...
                    FAQ.Question(question: "А в чём тогда смысл набирать много?", answer: "Во-первых, после каждого турнира будут появляться рейтинги лучших. Во-вторых, топ-3 участника по результатам сезона получат призы."),
