        ...
        sections: [
            FAQ.Section(
                ...
                questions: [
                    ...
                    FAQ.Question(question: "А виртуальная валюта никак не конвертируется в реальные деньги?", answer: "Конвертируется по курсу 1 чгкоин = 0 рублей."),
                    FAQ.Question(question: "А в чём тогда смысл набирать много?", answer: "Во-первых, после каждого турнира будут появляться рейтинги лучших. Во-вторых, топ-3 участника по результатам сезона получат символические призы."),
                    ...
                    FAQ.Question(question: "А если моя уверенность в неправильности коэффициента основывается не на общих соображениях, а на каком-то секретном знании?", answer: "Если тебе известно какое-то обстоятельство, которое неизвестно остальным и существенно меняет расклад (например, самый сильный игрок вашей команды не сможет приехать на турнир), то ты можешь мне об этом написать, и я исправлю коэффициенты."),
            ...
            FAQ.Section(
                ...
                questions: [
                    FAQ.Question(question: "Кто авторы этого проекта?", answer: "Меня зовут Эдгар (rating.chgk.info/player/63668). Мне принадлежит идея, я придумывал ставки и высчитывал коэффициенты, а также написал бекэнд и iOS-приложение. Android-приложение написал Ованнес (rating.chgk.info/player/63634)."),
